...
export type ListRefreshTokensResponse =
	ListRefreshTokensResponses[keyof ListRefreshTokensResponses];
...
export type GetDocumentReaderResponse =
	GetDocumentReaderResponses[keyof GetDocumentReaderResponses];
...
export type ExtensionCheckUrlResponse =
	ExtensionCheckUrlResponses[keyof ExtensionCheckUrlResponses];
...
export type ExtensionGetEntryResponse =
	ExtensionGetEntryResponses[keyof ExtensionGetEntryResponses];
...
export type RetrySubscriptionResponse =
	RetrySubscriptionResponses[keyof RetrySubscriptionResponses];
...
export type EmptyLibraryTrashResponse =
	EmptyLibraryTrashResponses[keyof EmptyLibraryTrashResponses];
...
export type ListTagHighlightsResponse =
	ListTagHighlightsResponses[keyof ListTagHighlightsResponses];
